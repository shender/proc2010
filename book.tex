...
\usepackage[unicode,colorlinks,pdfauthor={Igor Shenderovich, Ilya
  Barygin}, pdfsubject={Physical camp'2010. Report.},pdfkeywords={book, camp, 2010, physics, school}]{hyperref}
...
\pagestyle{fancy}
\rhead{\small\sffamily \emph{июль–август 2010}}
\lhead{\small\sffamily \emph{XVI летняя физическая школа}}
\cfoot{-- \sffamily\thepage \ -- }
\rfoot{\tiny \sffamily \href{http://physsummer.wordpress.com}{http://physsummer.wordpress.com}}
\lfoot{\tiny \sffamily
\href{mailto:physsummer@gmail.com}{physsummer@gmail.com}}
%\lfoot{\tiny \textsf{Летний физический лагерь, июль--август 2010}}
...
% \begin{figure}[h]
%   \centering
%   \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0005.jpg}}
%   \hspace{0.05\textwidth}
%   \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0007.jpg}}
% \end{figure}
...
\begin{figure}[h]
  ...
  \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0007.jpg}}
  \vspace{0.1\textwidth}
  \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0014.jpg}}
  \hspace{0.05\textwidth}
  \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0021.jpg}}
  \vspace{0.1\textwidth}
  \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0056.jpg}}
  \hspace{0.05\textwidth}
  \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0066.jpg}}
\end{figure}
...
% \begin{figure}[b]
%   \centering
%   \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0026.jpg}}
%   \hspace{0.05\textwidth}
%   \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0031.jpg}}
...
% \begin{figure}[h]
%   \centering
%   \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0051.jpg}}
%   \hspace{0.05\textwidth}
%   \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0056.jpg}}
% \end{figure}
...
% \begin{figure}[h]
%   \centering
%   \subfloat{\includegraphics[width=0.45\textwidth]{/adv/vert/0003.jpg}}
%   \hspace{0.05\textwidth}
%   \subfloat{\includegraphics[width=0.45\textwidth]{/adv/vert/0040.jpg}}
% \end{figure}
...
\begin{figure}[h]
  ...
  \hspace{0.4cm}
  \subfloat[О.В.\,Шустова]{\includegraphics[width=0.23\textwidth]{/faces/maitres/shustova_2}}
  \hspace{0.4cm}
...
смену. Во-первых, это \textbf{ежедневные задачи}. Каждое утро
школьники получают по две задачи (обычно это задачи из городских
олимпиад прошлых лет) для решения и сдачи преподавателям. Задачи могут
...
первое и второе воскресенье смены --- это \textbf{<<День
  Изобретателя>>} (см. \ref{sec:day_inventor}) и \textbf{<<День
  Экспериментатора>>} (см. \ref{sec:day_exp}). В <<День Изобретателя>>
школьникам предлагается построить установку, которая обеспечивает
заданный эффект или демонстрирует заданное явление. В <<День
Экспериментатора>> команды школьников соревнуются друг с другом в
решении сложных экспериментальных задач. За победу в этих конкурсах
школьники награждаются значками <<Лучший изобретатель>> и <<Лучший
экспериментатор>>.
...
\begin{figure}[h]
  \centering
  \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0076.jpg}}
  \hspace{0.05\textwidth}
  \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0093.jpg}}
  \vspace{0.1\textwidth}
  \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0123.jpg}}
  \hspace{0.05\textwidth}
  \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0127.jpg}}
  \vspace{0.1\textwidth}
  \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0137.jpg}}
  \hspace{0.05\textwidth}
  \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0172.jpg}}
\end{figure}
...
\begin{figure}[h]
  \centering
  \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0359.jpg}}
  \hspace{0.05\textwidth}
  \subfloat{\includegraphics[width=0.45\textwidth]{/adv/hor/0581.jpg}}
  \vspace{0.1\textwidth}
  \subfloat{\includegraphics[width=0.25\textwidth]{/adv/vert/0003.jpg}}
  \hspace{0.05\textwidth}
  \subfloat{\includegraphics[width=0.25\textwidth]{/adv/vert/0054.jpg}}
  \hspace{0.05\textwidth}
  \subfloat{\includegraphics[width=0.25\textwidth]{/adv/vert/0050.jpg}}
  \vspace{0.1\textwidth}
  \subfloat{\includegraphics[width=0.35\textwidth]{/adv/vert/0070.jpg}}
  \hspace{0.05\textwidth}
  \subfloat{\includegraphics[width=0.35\textwidth]{/adv/vert/0381.jpg}}
\end{figure}
...
измерительный прибор (возможна и обратная ситуация: измерительный
прибор, выдаваемый жюри, может сыграть нестандартную роль по ходу
